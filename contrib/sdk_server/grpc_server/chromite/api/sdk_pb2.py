...
from chromite.contrib.sdk_server.grpc_server.chromite.api import build_api_pb2 as chromite_dot_api_dot_build__api__pb2
...
_BUILDSDKTOOLCHAINREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='result_path', full_name='chromite.api.BuildSdkToolchainRequest.result_path', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BUILDSDKTOOLCHAINREQUEST.fields_by_name['result_path'].message_type = chromiumos_dot_common__pb2._RESULTPATH
...
UprevRequest = _reflection.GeneratedProtocolMessageType('UprevRequest', (_message.Message,), dict(
...
UprevResponse = _reflection.GeneratedProtocolMessageType('UprevResponse', (_message.Message,), dict(
...
BuildPrebuiltsRequest = _reflection.GeneratedProtocolMessageType('BuildPrebuiltsRequest', (_message.Message,), dict(
...
BuildPrebuiltsResponse = _reflection.GeneratedProtocolMessageType('BuildPrebuiltsResponse', (_message.Message,), dict(
...
BuildSdkTarballRequest = _reflection.GeneratedProtocolMessageType('BuildSdkTarballRequest', (_message.Message,), dict(
...
BuildSdkTarballResponse = _reflection.GeneratedProtocolMessageType('BuildSdkTarballResponse', (_message.Message,), dict(
...
CreateManifestFromSdkRequest = _reflection.GeneratedProtocolMessageType('CreateManifestFromSdkRequest', (_message.Message,), dict(
...
CreateManifestFromSdkResponse = _reflection.GeneratedProtocolMessageType('CreateManifestFromSdkResponse', (_message.Message,), dict(
...
CreateBinhostCLsRequest = _reflection.GeneratedProtocolMessageType('CreateBinhostCLsRequest', (_message.Message,), dict(
...
CreateBinhostCLsResponse = _reflection.GeneratedProtocolMessageType('CreateBinhostCLsResponse', (_message.Message,), dict(
...
UploadPrebuiltPackagesRequest = _reflection.GeneratedProtocolMessageType('UploadPrebuiltPackagesRequest', (_message.Message,), dict(
...
UploadPrebuiltPackagesResponse = _reflection.GeneratedProtocolMessageType('UploadPrebuiltPackagesResponse', (_message.Message,), dict(
...
BuildSdkToolchainRequest = _reflection.GeneratedProtocolMessageType('BuildSdkToolchainRequest', (_message.Message,), dict(
...
BuildSdkToolchainResponse = _reflection.GeneratedProtocolMessageType('BuildSdkToolchainResponse', (_message.Message,), dict(
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('Z6go.chromium.org/chromiumos/infra/proto/go/chromite/api'))
...
_SDKSERVICE = _descriptor.ServiceDescriptor(
  ...
  file=DESCRIPTOR,
  index=0,
  options=_descriptor._ParseOptions(descriptor_pb2.ServiceOptions(), _b('\302\355\032\007\n\003sdk\020\002')),
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\302\355\032\002\020\001')),
  ),
  _descriptor.MethodDescriptor(
    name='Uprev',
