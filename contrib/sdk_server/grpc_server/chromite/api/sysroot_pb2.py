...
from chromite.contrib.sdk_server.grpc_server.chromiumos import metrics_pb2 as chromiumos_dot_metrics__pb2
...
_SYSROOTCREATEREQUEST_FLAGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_cq_prebuilts', full_name='chromite.api.SysrootCreateRequest.Flags.use_cq_prebuilts', index=3,
...
_INSTALLTOOLCHAINREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='result_path', full_name='chromite.api.InstallToolchainRequest.result_path', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INSTALLPACKAGESREQUEST_FLAGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bazel', full_name='chromite.api.InstallPackagesRequest.Flags.bazel', index=5,
...
_INSTALLPACKAGESREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='result_path', full_name='chromite.api.InstallPackagesRequest.result_path', index=8,
...
_INSTALLTOOLCHAINREQUEST.fields_by_name['result_path'].message_type = chromiumos_dot_common__pb2._RESULTPATH
...
_INSTALLPACKAGESREQUEST.fields_by_name['result_path'].message_type = chromiumos_dot_common__pb2._RESULTPATH
...
FailedPackageData = _reflection.GeneratedProtocolMessageType('FailedPackageData', (_message.Message,), dict(
...
_SYSROOTSERVICE = _descriptor.ServiceDescriptor(
  ...
  file=DESCRIPTOR,
  index=0,
  options=_descriptor._ParseOptions(descriptor_pb2.ServiceOptions(), _b('\302\355\032\013\n\007sysroot\020\001')),
