...
CreateNetbootRequest = _reflection.GeneratedProtocolMessageType('CreateNetbootRequest', (_message.Message,), dict(
...
CreateNetbootResponse = _reflection.GeneratedProtocolMessageType('CreateNetbootResponse', (_message.Message,), dict(
...
_IMAGESERVICE = _descriptor.ServiceDescriptor(
  ...
  file=DESCRIPTOR,
  index=0,
  options=_descriptor._ParseOptions(descriptor_pb2.ServiceOptions(), _b('\302\355\032\t\n\005image\020\001')),
